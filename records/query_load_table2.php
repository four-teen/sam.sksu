...
WHERE 
    (
        /* CONDITION A — documents originally received by this office,
           and NOT yet sent OUT */
    ...
    OR
    (
        /* CONDITION B — documents forwarded/transmitted/redirected to you 
           AND NOT sent OUT yet */
        EXISTS (
            SELECT 1 
        ...
        AND NOT EXISTS (
            SELECT 1 
            FROM tbl_document_actions a3
            WHERE a3.doc_id = d.doc_id
              AND a3.from_office_id = '$office_id'
              AND a3.action_type = 'Outgoing'
        )
    )
