...
if (isset($_POST['get_counts'])) {
    ...
    $q1 = mysqli_query($conn, "SELECT COUNT(*) AS c FROM tbl_vehicle_request WHERE status='Pending'");
    $counts['Pending'] = mysqli_fetch_assoc($q1)['c'];

    $q2 = mysqli_query($conn, "SELECT COUNT(*) AS c FROM tbl_vehicle_request WHERE status='Approved'");
    $counts['Approved'] = mysqli_fetch_assoc($q2)['c'];

    $q3 = mysqli_query($conn, "SELECT COUNT(*) AS c FROM tbl_vehicle_request WHERE status='Disapproved'");
    $counts['Disapproved'] = mysqli_fetch_assoc($q3)['c'];
...
if (isset($_POST['delete_request'])) {
    ...
    $sql = "DELETE FROM tbl_vehicle_request WHERE requestid = '$id'";
